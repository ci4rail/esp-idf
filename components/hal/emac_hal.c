...
void emac_hal_init_dma_default(emac_hal_context_t *hal)
{
    ...
    emac_ll_set_rx_dma_pbl(hal->dma_regs, EMAC_LL_DMA_BURST_LENGTH_8BEAT); // ci4rail: reduced from 32 to 8 bits. See https://github.com/espressif/esp-idf/pull/7874/commits/47875468430959b3707cae6c0735e3bd5fc163e9
